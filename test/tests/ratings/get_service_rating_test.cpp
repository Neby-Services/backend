...
class GetServiceRatingCorrect : public testing::Test {
protected:
...
TEST_F(GetServiceRatingCorrect, get_rating_service_correct) {

    std::string get_ratings_url = "http://backend:" + std::to_string(HTTP_PORT) + "/api/ratings/service/"+ _service_id_;
	...
	EXPECT_EQ(r_get.status_code, 200) << "Expected 201 status code for rating obtained succesfully: ";
